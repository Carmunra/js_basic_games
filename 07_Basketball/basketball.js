...
function input(){
    ...
    return new Promise(function(resolve){
        ...
        print("? ");
        input_element.setAttibute("type", "text");
        input_element.setAttibute("length", "50");
...
function half_time(){
    print("\n");
    print("   ***** END OF FISRT HALF *****\n");
    print("SCORE: DARMOUNTH: " + s[1] + " " + os + ": " + s[0] + "\n");
    print("\n");
    print("\n");
}
    ...
    if(z == 1 || z == 2){
        ...
        if(Math.random() <= 0.682 * d /8){
            ...
            if(Math.random() > 0.4){
                if(d == 6){
                    if(Math.random() > 0.6){
                        print("PASS STOLEN BY " + os + " EASE LAYUP.\n");
                        score_computer();
                        return;
                    }
                }
                print("BALL PASSES BACK TO YOU. ");
                your_turn = 1;
                return;
            }
